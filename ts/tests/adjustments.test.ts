...
describe("color adjustments", () => {
  describe("lighten()", () => {
    it("lighten(1) produces white", () => {
      const c = new KleurStruct(100, 50, 50);
    ...
    it("lighten(0.5) increases lightness by half the remaining range", () => {
      const c = new KleurStruct(255, 0, 0); // l=50
  ...
  describe("darken()", () => {
    it("darken(1) produces black", () => {
      const c = new KleurStruct(100, 150, 200);
  ...
  describe("saturate()", () => {
    it("saturate(1) fully saturates", () => {
      const c = new KleurStruct(128, 100, 100); // partially saturated
  ...
  describe("grayscale()", () => {
    ...
    it("preserves alpha", () => {
      const c = new KleurStruct(255, 0, 0, 0.5);
  ...
  describe("rotate()", () => {
    it("rotates hue by given degrees", () => {
      const c = new KleurStruct(255, 0, 0); // hue=0
  ...
  describe("complement()", () => {
    ...
    it("is equivalent to rotate(180)", () => {
      const c = new KleurStruct(100, 149, 237);
  ...
  describe("warm()", () => {
    it("shifts hue toward orange (30°)", () => {
      const blue = new KleurStruct(0, 0, 255); // hue=240
    ...
    it("defaults amount to 0.2", () => {
      const c = new KleurStruct(0, 0, 255);
      const warmed = c.warm();
  ...
  describe("cool()", () => {
    it("shifts hue toward blue (240°)", () => {
      const red = new KleurStruct(255, 0, 0); // hue=0
  ...
  describe("invert()", () => {
    ...
    it("preserves alpha", () => {
      const c = new KleurStruct(255, 0, 0, 0.3);
  ...
  describe("opaque()", () => {
    ...
    it("preserves RGB", () => {
      const c = new KleurStruct(100, 150, 200, 0.5);
      const o = c.opaque();
      expect(o.r).toBe(100);
      expect(o.g).toBe(150);
      expect(o.b).toBe(200);
