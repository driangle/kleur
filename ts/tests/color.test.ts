...
describe("Color", () => {
  describe("construction and clamping", () => {
    ...
    it("rounds fractional RGB values", () => {
      const c = new Color(66.7, 135.2, 244.5);
      expect(c.r).toBe(67);
      expect(c.g).toBe(135);
      expect(c.b).toBe(245);
    });
  ...
  describe("immutable setters", () => {
    const base = new Color(100, 150, 200, 0.9);
